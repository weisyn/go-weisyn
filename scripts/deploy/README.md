...
# 网络配置
export WES_HTTP_PORT=8080
export WES_GRPC_PORT=9090
export WES_WS_PORT=8081
export WES_P2P_PORT=4001
...
# 检查各服务
check_service_health "HTTP API" "http://localhost:8080/health"
check_service_health "gRPC API" "http://localhost:9090/health"
```
