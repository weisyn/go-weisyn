...
graph TB
    subgraph "共识内部接口架构"
        subgraph "聚合器接口层"
            ...
            DISTANCE_SELECTOR["📏 距离选择器<br/>DistanceSelector"]
...
classDiagram
    ...
    class DistanceSelector {
        ...
        +VerifyDistanceSelection(selected CandidateBlock, proof DistanceSelectionProof) error
    }
    ...
    InternalAggregatorService --> DistanceSelector : composes
