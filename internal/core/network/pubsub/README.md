...
graph TB
    subgraph "PubSub Module Architecture"
        ...
        subgraph "Message Processing"
            PUBLISHER["Message Publisher<br/>消息发布器"]
            VALIDATOR["Message Validator<br/>消息验证器"]
            ENCODER["Message Encoder<br/>消息编码器"]
            DISTRIBUTOR["Message Distributor<br/>消息分发器"]
        end
        
        subgraph "Quality Control"
            DEDUP_FILTER["Dedup Filter<br/>去重过滤器"]
            RATE_LIMITER["Rate Limiter<br/>速率限制器"]
            ORDER_MANAGER["Order Manager<br/>顺序管理器"]
            FLOW_CONTROLLER["Flow Controller<br/>流量控制器"]
        end
        
        subgraph "P2P Integration"
            GOSSIPSUB_ADAPTER["GossipSub Adapter<br/>GossipSub适配器"]
            PEER_MANAGER["Peer Manager<br/>节点管理器"]
        end
    end
