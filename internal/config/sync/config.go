...
type SyncOptions struct {
	...
	// === 资源管理配置 ===
	MemoryPressureThreshold int64 `json:"memory_pressure_threshold"` // 内存压力阈值（字节），超过此值将触发优化
...
// GetMemoryPressureThreshold 获取内存压力阈值
func (c *Config) GetMemoryPressureThreshold() int64 {
	return c.options.MemoryPressureThreshold
}
